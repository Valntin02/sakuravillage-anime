...
import com.sakuravillage.SakuraVillageApplication;
...
public class NetworkHelper {
    ...
    public static Retrofit getRetrofitInstance(String baseUrl) {
        try {
            // 加载自定义证书
            InputStream caInput = SakuraVillageApplication.getAppContext().getResources().openRawResource(R.raw.mycet); // 证书文件
