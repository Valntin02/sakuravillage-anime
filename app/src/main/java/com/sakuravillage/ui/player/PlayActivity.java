...
import com.sakuravillage.databinding.ActivityPlayBinding;
import com.sakuravillage.R;
import com.sakuravillage.util.OnTransitionListener;
import com.sakuravillage.data.model.SwitchVideoModel;
...
public class PlayActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        binding.videoPlayer.setUp(list.get(0).getUrl(), false, "测试视频");
