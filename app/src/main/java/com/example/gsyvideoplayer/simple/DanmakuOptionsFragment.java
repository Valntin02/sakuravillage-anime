...
public class DanmakuOptionsFragment extends BottomSheetDialogFragment {
    ...
    private void sendDanmaku() {
        ...
        DanmakuReqModel danmakuReqModel=new DanmakuReqModel(vodData.getVod_id(),vodRid,postion,selectedType,color,content,useId);
        ApiService apiService = RetrofitClient.getRetrofitInstance().create(ApiService.class);
        Call<JsonResModel> call = apiService.sendDanmaku(danmakuReqModel,token);
